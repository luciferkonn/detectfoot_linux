...
proc create_root_design { parentCell } {
  ...
  # Create instance: DetectorNewStep_0, and set properties
  set DetectorNewStep_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:DetectorNewStep:1.0 DetectorNewStep_0 ]
  ...
  set_property -dict [ list CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100} CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.preset {ZC702}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net DetectorNewStep_0_step [get_bd_intf_pins DetectorNewStep_0/step] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins DetectorNewStep_0/oriValues] [get_bd_intf_pins axi_dma/M_AXIS_MM2S]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DetectorNewStep_0/ap_clk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins DetectorNewStep_0/ap_rst_n] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DetectorNewStep_0/ap_start] [get_bd_pins xlconstant_0/dout]
